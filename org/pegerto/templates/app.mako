...
<article class="module width_full">
		<header><h3 class="tabs_involved">Applications Configured</h3>
		</header>
			...
			<tbody id="applist">
				<template id="approw"> 
					<tr id="{{appid}}"> 
    					...
    					<td>{{group}}</td> 
    					<td></td> 
    					<td><input type="image" src="/static/images/icn_edit.png" title="Edit"><input type="image" src="/static/images/icn_trash.png" title="Trash"></td> 
					</tr> 
				</template>  
			</tbody> 
			</table>
	...
	<article class="module width_full" id="newapp">
			<header><h3>New Application</h3></header>
				<div class="module_content">
						...
						<fieldset  style="width:48%; float:left; margin-right: 3%;">
							<label>APP-ID</label>
							<input type="text" id="appid" style="width:93%;"></input>
						</fieldset>
						<fieldset  style="width:48%; float:right;">
							<label>Token</label>
							<div class="clear"></div>
							<input type="text" id="token" style="width:60%; float: left margin-right: 3%;"></input>
							<input type="submit" value="Generate" class="alt_btn" id="generate" style="float:right; margin-right: 3%;">
							<div class="clear"></div>
						</fieldset>
